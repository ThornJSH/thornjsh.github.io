...
const pageMap = {
    ...
    'Modern Excel 호환 패키지': '/miniapp-excel-mecp.html',
    'Modern Excel Compatibility Pack': '/miniapp-excel-mecp.html',
    'Modern Excel Compatibility Pack (MECP)': '/miniapp-excel-mecp.html',
